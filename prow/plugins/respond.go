...
const AboutThisBotWithoutCommands = "If you have questions or suggestions related to my behavior, please file an issue against the [prometheus/prombench](https://github.com/prometheus/prombench/issues) repository."
const AboutThisBotCommands = "I understand the commands that are listed [here](https://github.com/prometheus/prombench/)."
